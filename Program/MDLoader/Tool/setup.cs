...
namespace MDLoader
{
    ...
    public class Config
    {
        ...
        public int ViewZoomFactor { get; set; }
        ...
        [CategoryAttribute("3.Picture Setup")]
        [DescriptionAttribute("截图缩放比例，比如设置为50，或者30,70")]
        public int ScreenShotFactor { get; set; }
        [CategoryAttribute("4.Agent Setup")]
        [DescriptionAttribute("AI Agent的 APIkey，Agent需要兼容OpenAI REST 格式")]
        public string AgentAPIKey { get; set; }

        [CategoryAttribute("4.Agent Setup")]
        [DescriptionAttribute("AI Agent的 Address，Agent需要兼容OpenAI REST 格式")]
        public string AgentAddress { get; set; }

        [CategoryAttribute("4.Agent Setup")]
        [DescriptionAttribute("Search Agent的 APIkey")]
        public string SearchAPIKey { get; set; }

        [CategoryAttribute("4.Agent Setup")]
        [DescriptionAttribute("Search Agent的 Address")]
